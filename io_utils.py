...
def parse_args(script):
    ...
    parser.add_argument(
        "--model",
        default="Conv4",
        help="model: Conv{4|6}{Pool} / ResNet{10|18|34|50|101}",
    ...
    parser.add_argument(
        ...
        help="baseline/baseline++/protonet/matchingnet/relationnet{_softmax}/maml{_approx}/hn_poc/hyper_maml/bayes_hmaml",
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Suffix for custom experiment differentiation",
    )
    # saved in save/checkpoints/[dataset]
    parser.add_argument("--lr", type=float, default=1e-3, help="Learning rate")
    parser.add_argument(
        "--optim", type=str, choices=["adam", "sgd"], help="Optimizer", default="adam"
    )
    parser.add_argument(
        "--n_val_perms",
        type=int,
        default=1,
        help="Number of task permutations in evaluation.",
    )
    parser.add_argument(
        "--lr_scheduler",
        type=str,
        help="LR scheduler",
        default="none",
        choices=["multisteplr", "none", "cosine", "reducelronplateau"],
    )
    parser.add_argument(
        "--milestones",
        nargs="+",
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="if to save feature net used in MAML",
    )
    parser.add_argument(
        "--maml_adapt_classifier",
        action="store_true",
        help="Adapt only the classifier during second gradient calculation",
    )
    parser.add_argument(
        "--evaluate_model",
        action="store_true",
        help="Skip train phase and perform final test",
    )
    ...
    if script == "train":
        ...
        parser.add_argument(
            "--eval_freq", type=int, default=1, help="Evaluation frequency"
        )
